...
- [V2-P6 Narrated Slides Acceptance Checklist](plans/v2/2026-04-25-v2-p6-acceptance-checklist.md) — Manual acceptance steps for `init-narrated-plan` and narrated v2 render preview
