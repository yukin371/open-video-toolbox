...
static void PrintUsage()
{
    ...
    Console.WriteLine("  init-narrated-plan --manifest <narrated.json> --output <edit.json> [--template <id>] [--render-output <path>] [--ffprobe <path>] [--timeout-seconds <n>] [--json-out <path>]");
