...
internal sealed record AttachPlanMaterialBatchManifest
{
    public int SchemaVersion { get; init; } = 1;

    public IReadOnlyList<AttachPlanMaterialBatchItem> Items { get; init; } = [];
}

internal sealed record AttachPlanMaterialBatchItem
{
